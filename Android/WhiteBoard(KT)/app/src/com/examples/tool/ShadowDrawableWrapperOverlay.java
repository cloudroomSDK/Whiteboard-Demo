...
/**
 * android.support.design.widget.ShadowDrawableWrapper 的覆写类
 * <p>
 * A {@link android.graphics.drawable.Drawable} which wraps another drawable and
 * draws a shadow around it.
 */
public class ShadowDrawableWrapperOverlay extends DrawableWrapperOverlay {
    ...
    private int mShadowStartColor = 0x00000000;
    private int mShadowMiddleColor = 0x14000000;
    ...
    public ShadowDrawableWrapperOverlay(Context context, Drawable content, float radius,
    ...
    public ShadowDrawableWrapperOverlay(Context context, Drawable content, float radius,
                                        int shadowStartColor, int shadowMiddleColor, int shadowEndColor,
                                        float shadowSize, float maxShadowSize) {
        this(context, content, radius, shadowSize, maxShadowSize);

        mShadowStartColor = shadowStartColor;
        mShadowMiddleColor = shadowMiddleColor;
