...
//	public static final String DEFAULT_SERVER = "crlab.cloudroom.com";
	public static final String DEFAULT_SERVER = "sdk.cloudroom.com";
	public static final String DEFAULT_APPID = "demo@cloudroom.com";
	public static final String DEFAULT_APPSECRET = com.examples.tool.MD5Util.MD5("123456");
	public static final String DEFAULT_DATENC_TYPE = "0";
	...
	private void saveAndFinish() {
		...
		if(!oldAppSecret.equals(appSecret)) {
			...
			if (!DEFAULT_APPSECRET.equals(appSecret)) {
				appSecret = com.examples.tool.MD5Util.MD5(appSecret);
			}
			if (TextUtils.isEmpty(appSecret)) {
