...
- (void)setType:(PMRoundBtnType)type {
    ...
    switch (type) {
        case PMRoundBtnTypeDark: {
            self.backgroundColor = UIColorFromRGBA(41, 171, 145, 1.0);
        ...
        case PMRoundBtnTypeLight: {
            ...
            self.layer.cornerRadius = 20;
            self.layer.masksToBounds = YES;
            [self setTitleColor:UIColorFromRGBA(41, 171, 145, 1.0) forState:UIControlStateNormal];
            break;
        }
    }
}
...
- (void)setSelect:(BOOL)select {
    ...
    self.backgroundColor = select ? UIColorFromRGBA(41, 171, 145, 1.0) : [UIColor lightGrayColor];
